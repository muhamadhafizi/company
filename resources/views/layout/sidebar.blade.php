        ...
        <nav x-data="{ selected: $persist('Dashboard') }">
            ...
            <div>
                ...
                <ul class="flex flex-col gap-4 mb-6">
                    ...
                    <li>
                        <a href="{{ route('dashboard.index') }}" @click="selected = (selected === 'Dashboard' ? '':'Dashboard')"
                    ...
                    <li>
                        <a href="{{ route('companies.index') }}" @click="selected = (selected === 'Company' ? '':'Company')"
                            class="menu-item group"
                            :class="(selected === 'Company') && (page === 'company') ? 'menu-item-active' :
                            'menu-item-inactive'">
                            <svg :class="(selected === 'Company') && (page === 'company') ? 'menu-item-icon-active' :
                            'menu-item-icon-inactive'"
                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
